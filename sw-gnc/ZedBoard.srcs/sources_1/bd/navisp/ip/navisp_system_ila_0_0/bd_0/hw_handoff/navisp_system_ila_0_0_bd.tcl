...
################################################################
# This is a generated script based on design: bd_1828
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SLOT_0_AHBLITE_haddr_1 [get_bd_ports SLOT_0_AHBLITE_haddr] [get_bd_pins ila_lib/probe9]
  connect_bd_net -net SLOT_0_AHBLITE_hburst_1 [get_bd_ports SLOT_0_AHBLITE_hburst] [get_bd_pins ila_lib/probe11]
  connect_bd_net -net SLOT_0_AHBLITE_hmastlock_1 [get_bd_ports SLOT_0_AHBLITE_hmastlock] [get_bd_pins ila_lib/probe10]
  connect_bd_net -net SLOT_0_AHBLITE_hprot_1 [get_bd_ports SLOT_0_AHBLITE_hprot] [get_bd_pins ila_lib/probe3]
  connect_bd_net -net SLOT_0_AHBLITE_hrdata_1 [get_bd_ports SLOT_0_AHBLITE_hrdata] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net SLOT_0_AHBLITE_hready_1 [get_bd_ports SLOT_0_AHBLITE_hready] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net SLOT_0_AHBLITE_hresp_1 [get_bd_ports SLOT_0_AHBLITE_hresp] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net SLOT_0_AHBLITE_hsize_1 [get_bd_ports SLOT_0_AHBLITE_hsize] [get_bd_pins ila_lib/probe4]
  connect_bd_net -net SLOT_0_AHBLITE_htrans_1 [get_bd_ports SLOT_0_AHBLITE_htrans] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_AHBLITE_hwdata_1 [get_bd_ports SLOT_0_AHBLITE_hwdata] [get_bd_pins ila_lib/probe12]
  connect_bd_net -net SLOT_0_AHBLITE_hwrite_1 [get_bd_ports SLOT_0_AHBLITE_hwrite] [get_bd_pins ila_lib/probe7]
