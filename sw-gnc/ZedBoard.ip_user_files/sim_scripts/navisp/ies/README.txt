...
#
# Generated by export_simulation on Thu Feb 06 06:07:51 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './navisp.sh' script.
...
./navisp.sh -noclean_files

For more information on the script, please type './navisp.sh -help'.
