...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.navisp \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/8c62/hdl" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/ec67/hdl" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/8c62/hdl" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ip/navisp_processing_system7_0_0" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/1b7e/hdl/verilog" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/122e/hdl/verilog" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/6887/hdl/verilog" \
       +incdir+"../../../../ZedBoard.srcs/sources_1/bd/navisp/ipshared/9623/hdl/verilog" \
       +incdir+"G:/Xilinx/Vivado/2019.1/data/xilinx_vip/include"
}
