...
HD_PWD='D:/Projects/Hipero/svn/dev/fpga/ip_projects/payload_partition/payload_partition.runs/payload_partition_axi_cdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log payload_partition_axi_cdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source payload_partition_axi_cdma_0_0.tcl
