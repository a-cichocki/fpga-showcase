...
HD_PWD='G:/EMICAP/semicap/semicap.runs/semicap_axi_hwicap_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log semicap_axi_hwicap_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source semicap_axi_hwicap_0_0.tcl
