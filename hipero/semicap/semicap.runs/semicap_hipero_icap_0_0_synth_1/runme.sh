...
HD_PWD='G:/EMICAP/semicap/semicap.runs/semicap_hipero_icap_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log semicap_hipero_icap_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source semicap_hipero_icap_0_0.tcl
