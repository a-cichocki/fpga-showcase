...
elaborate()
{
  xelab --relax --debug typical --mt auto -L sem_ultra_v3_1_11 -L hipero -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L lib_pkg_v1_0_2 -L fifo_generator_v13_2_4 -L lib_fifo_v1_0_13 -L interrupt_control_v3_1_4 -L axi_hwicap_v3_0_23 -L cbkpan -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot semicap hipero.semicap hipero.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim semicap -key {Behavioral:sim_1:Functional:semicap} -tclbatch cmd.tcl -protoinst "protoinst_files/semicap.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(hipero fifo_generator_v13_2_4)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb semicap.wdb xsim.dir)
