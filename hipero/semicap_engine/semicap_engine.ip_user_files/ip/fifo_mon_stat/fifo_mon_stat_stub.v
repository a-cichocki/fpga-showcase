...
// Command     : write_verilog -force -mode synth_stub -rename_top fifo_mon_stat -prefix
//               fifo_mon_stat_ fifo_mon_cmd_stub.v
// Design      : fifo_mon_cmd
...
module fifo_mon_stat(clk, srst, din, wr_en, rd_en, dout, full, empty, 
